	...
	
{
	...
	/// In accordance with the license requirement of 
	
	/// documenting changes, this method has been added by 
	
	/// Dustin Horne (http://www.dustinhorne.com) to allow 
	
	/// retrieving the raw bytes of the computed hash
	...
	/// documenting changes, this method has modified 
	
	/// by Dustin Horne (http://www.dustinhorne.com) 
	
	/// to call the new GetMd5Bytes method
	
	static public string GetMd5String(String source)
		
	{
		
		var hash = GetMd5Bytes(source);
